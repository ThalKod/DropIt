...
function chunksComplete(responseText) {
    ...
    document.querySelector('#copylink').value = data.url;
    ...
    addthis.update('share', 'url', data.url);
    addthis.update('share', 'title', 'Download ' + data.name + ' from Uploadfiles.io');
}
